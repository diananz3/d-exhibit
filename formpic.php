                ...
                <div class="signup-content">
                    <div class="signin-form">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="note" id="note" placeholder="Deskripsi"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div>
                        ...
                        <ol>
                            ...
                            <li>Gambar square (nxn) minimal 400x400 untuk kualitas tampilan gambar yang bagus</li>
